          ...
          <div className="bg-white rounded-[2.5rem] p-8 md:p-16 overflow-hidden relative border border-gray-200 shadow-xl">
            <div className="max-w-2xl mx-auto relative z-10 text-center">
              ...
              <p className="text-gray-500 text-xl mb-12 leading-relaxed">
                Madam Tola used to spend hours sending food photos to every new customer. Now, she just sends her <span className="text-orange-600 font-bold">NaijaBiz link</span>.
              </p>
              ...
              <div className="grid gap-6 md:grid-cols-3 mb-10 text-left">
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  ...
                  <h4 className="font-bold text-gray-900 mb-2">1. Full Menu</h4>
                  <p className="text-sm text-gray-500">Shoppers see full menu and prices instantly.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mb-4">
                    <Clock className="w-5 h-5 text-green-600" />
                  </div>
                  <h4 className="font-bold text-gray-900 mb-2">2. Saves Time</h4>
                  <p className="text-sm text-gray-500">No more searching gallery for photos to forward.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mb-4">
                    <TrendingUp className="w-5 h-5 text-green-600" />
                  </div>
                  <h4 className="font-bold text-gray-900 mb-2">3. More Sales</h4>
                  <p className="text-sm text-gray-500">Easier for customers to choose and pay.</p>
                </div>
              </div>

              <div>
                <Link href="/signup">
                  <Button size="lg" className="bg-orange-600 hover:bg-orange-700 text-white font-bold h-12 px-8 shadow-lg shadow-orange-100">
                    Create your page like Tola <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </Link>
              </div>
            </div>
