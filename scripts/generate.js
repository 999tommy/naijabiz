...
function generate() {
    ...
    for (let i = 0; i < total; i++) {
        ...
        // Default catId fallback to 'others' 
        const catId = CategoryMap[tKey] || CategoryMap.others
        ...
        accounts.push({ auth, user, products })
    }
